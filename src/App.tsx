    ...
    if (voiceMode === "gemini") {
      try {
        ...
        ctx.decodeAudioData(
          ...
          (err) => {
            console.error("PCM decoding failed, falling back to window SpeechSynthesis...", err);
            speakTextLocal(text);
          }
        );
      } catch (err) {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-amber-100 pb-16 flex flex-col justify-between">
      ...
      <header className="bg-white border-b border-slate-100 py-3.5 px-4 sticky top-0 z-40 shadow-3xs">
        <div className="max-w-7xl mx-auto flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-600 flex items-center justify-center text-white font-extrabold text-lg shadow-sm">
              S!
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <h1 className="text-base font-extrabold text-slate-900 tracking-tight">SakuSaku AI</h1>
      ...
      <footer className="mt-12 text-center text-[11px] text-slate-400 max-w-xl mx-auto space-y-2 px-4">
        ...
        <div className="flex justify-center gap-4 text-[10px] pt-1">
          <span className="font-extrabold text-slate-400">SakuSaku AI v1.5</span>
          <span>●</span>
